...
<div id="wplp-save-toolbar">
	<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
		...
		<div class="btn-group" role="group" aria-label="First group">
			...
			<a href="<?php echo WP_RESPONSIVE_LANDING_PAGES_URL."responsive/desktop.php?url="; ?><?php echo $wp_responsive_current_page; ?>" target="_blank" class="btn btn-secondary btn-warning"><i class="fa fa-tv"></i></a>
			<a href="<?php echo WP_RESPONSIVE_LANDING_PAGES_URL."responsive/ipad.php?url="; ?><<?php echo $wp_responsive_current_page; ?>" target="_blank" class="btn btn-secondary btn-warning"><i class="fa fa-tv"></i></a>
			<a href="<?php echo WP_RESPONSIVE_LANDING_PAGES_URL."responsive/mobile.php?url="; ?><?php echo $wp_responsive_current_page; ?>" target="_blank" class="btn btn-secondary btn-warning"><i class="fa fa-mobile"></i></a>
		</div>
